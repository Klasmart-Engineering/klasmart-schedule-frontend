...
export type QeuryPermissionOfMeQuery = (
  { __typename?: 'Query' }
  & { me?: Types.Maybe<(
    { __typename?: 'User' }
...
export const QeuryPermissionOfMeDocument = gql`
    query qeuryPermissionOfMe($organization_id: ID!) {
  me {
 ...
 * });
 */
export function useQeuryPermissionOfMeQuery(baseOptions?: Apollo.QueryHookOptions<QeuryPermissionOfMeQuery, QeuryPermissionOfMeQueryVariables>) {
...
export function useQeuryPermissionOfMeLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<QeuryPermissionOfMeQuery, QeuryPermissionOfMeQueryVariables>) {
