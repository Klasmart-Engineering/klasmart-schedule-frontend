...
import { Table, TableHead, TableCell, TableBody, TableRow, Box, makeStyles, TableContainer, Typography, TextField, Button } from "@material-ui/core";
  ...
  const library=(
    ...
    <Box display="flex" pt={2.5}>
      <TextField
        ...
        placeholder="Search"
      />
      <Button color="primary" variant="contained" size="small" className={css.fieldset} startIcon={<Search/>}>Search</Button>
    </Box>
    {table}
  </Box>
