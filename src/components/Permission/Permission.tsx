...
export enum PermissionType {
  ...
  view_completed_assessments__414 = "view_completed_assessments__414",
  view_in_progress_assessments_415 = "view_in_progress_assessments_415",
  view_published_learning_outcome__416 = "view_published_learning_outcome__416",
  create_learning_outcome__421 = "create_learning_outcome__421",
  ...
  edit_publsihed_learning_outcome_436 = "edit_publsihed_learning_outcome_436",
